...
!write(*,"(4i6,i4,3f12.3)") DIHEDRALS(IDIHE)%I, DIHEDRALS(IDIHE)%J, DIHEDRALS(IDIHE)%K, DIHEDRALS(IDIHE)%L, &
!			DIHEDRALS(IDIHE)%PERIOD, DIHEDRALS(IDIHE)%FC, DIHEDRALS(IDIHE)%PHASE, COSNPHI
