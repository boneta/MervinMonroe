...
PRIVATE
PUBLIC :: ABINITIO_SETUP, ABINITIO_ENERGY, ABINITIO_GRADIENT, ABINITIO_HESSIAN
...
SUBROUTINE ABINITIO_NON_BONDED( SELECTION )
	...
	! cut-off based selection (no switching function or so...)
...
SUBROUTINE ABINITIO_ENERGY( ENERGY )
    ...
    CODE = 0
    CALL ABINITIO_SERVER( CODE, NT, NATOMSQM, EXT_ATMN, EXT_CORD, EXT_ENER, EXT_GRAD, EXT_HESS )
