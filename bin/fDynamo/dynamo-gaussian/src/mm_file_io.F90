...
#ifdef	HACK_AMBER
      DIHEPS(1:NDIHEPS)%V4 = KCAL_TO_KJ * DIHEPS(1:NDIHEPS)%V4
#endif
...
#ifdef	HACK_AMBER
      IMPRPS(1:NIMPRPS)%V4 = KCAL_TO_KJ * IMPRPS(1:NIMPRPS)%V4
#endif
...
#ifdef	HACK_AMBER
         V0 = 0.5_DP * V0 ; V1 = 0.5_DP * V1 ; V2 = 0.5_DP * V2 ; V3 = 0.5_DP * V3; V4 = 0.5_DP * V4
#else
...
#ifdef	HACK_AMBER
         WRITE ( TUNIT ) I, J, K, L, V0, V1, V2, V3, V4
#else
...
#ifdef	HACK_AMBER
                        DIHEPS(P)%V0,    DIHEPS(P)%V1,    DIHEPS(P)%V2,    DIHEPS(P)%V3, DIHEPS(P)%V4
#else
...
#ifdef	HACK_AMBER
                        IMPRPS(P)%V0,    IMPRPS(P)%V1,    IMPRPS(P)%V2,    IMPRPS(P)%V3, IMPRPS(P)%V4
#else
